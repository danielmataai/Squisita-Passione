...
const translations = {
  en: {
    ...
    // Tours Page
    'tours.page.hero.eyebrow': '7 Days in Tuscany',
    'tours.page.hero.title': 'Informal Gastronomic Tours',
    'tours.page.hero.description': 'A week of culinary adventures through the heart of Florence and Tuscany',
    ...
    'tours.page.cta.text': 'Let\'s plan your perfect Italian food journey. Contact Chef Davide to start designing your unforgettable week in Tuscany.',
  ...
  fr: {
    ...
    // Tours Page
    'tours.page.hero.eyebrow': '7 Jours en Toscane',
    'tours.page.hero.title': 'Tours Gastronomiques Informels',
    'tours.page.hero.description': 'Une semaine d\'aventures culinaires au cœur de Florence et de la Toscane',
    ...
    'tours.page.cta.text': 'Planifions votre voyage culinaire italien parfait. Contactez le Chef Davide pour commencer à concevoir votre semaine inoubliable en Toscane.',
