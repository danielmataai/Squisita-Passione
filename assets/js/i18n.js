...
const translations = {
  en: {
    ...
    'tours.page.hero.title': 'Priority List',
    'tours.page.hero.description': 'Informal Gastronomic Tours \u2014 Florence & Tuscany',
    'tours.page.hero.cta': 'Reserve My Spot',

    // Priority List Section
    'tours.pl.eyebrow': 'Priority List \u2014 Limited to 10 Guests',
    'tours.pl.title': 'Your Tuscan Adventure Starts Here',
    'tours.pl.progress': '<strong>3 of 10</strong> spots claimed \u2014 once full, the tour is confirmed',
    'tours.pl.step1': 'Enter your details',
    'tours.pl.name': 'Full Name',
    'tours.pl.email': 'Email Address',
    'tours.pl.submit': 'Reserve My Spot',
    'tours.pl.formnote': 'No payment info required here \u2014 just your name to hold your place.',
    'tours.pl.success.title': 'You\'re in!',
    'tours.pl.success.text': 'Now complete the deposit to lock in your spot.',
    'tours.pl.perks.title': 'Early bird advantages',
    'tours.pl.perks.p1': 'Priority room selection',
    'tours.pl.perks.p2': 'Help shape the experience',
    'tours.pl.perks.p3': 'Locked-in pricing guarantee',
    'tours.pl.step2': 'Secure with deposit',
    'tours.pl.or': 'or',
    'tours.pl.paypal': 'Pay $300 CAD via PayPal',
    'tours.pl.trust1': '100% refundable, anytime',
    'tours.pl.trust2': 'Confirmation within 24h',
    'tours.pl.next1': 'You join the list',
    'tours.pl.next2': 'Chef Davide confirms in 24h',
    'tours.pl.next3': '10 guests reached = tour confirmed',
  ...
  fr: {
    ...
    'tours.page.hero.eyebrow': 'Chef Davide Rizzardi',
    'tours.page.hero.title': 'Liste Prioritaire',
    'tours.page.hero.description': 'Tours Gastronomiques Informels \u2014 Florence et Toscane',
    'tours.page.hero.cta': 'R\u00e9server Ma Place',

    // Priority List Section
    'tours.pl.eyebrow': 'Liste Prioritaire \u2014 Limit\u00e9 \u00e0 10 Invit\u00e9s',
    'tours.pl.title': 'Votre Aventure Toscane Commence Ici',
    'tours.pl.progress': '<strong>3 sur 10</strong> places r\u00e9serv\u00e9es \u2014 une fois complet, le tour est confirm\u00e9',
    'tours.pl.step1': 'Entrez vos coordonn\u00e9es',
    'tours.pl.name': 'Nom Complet',
    'tours.pl.email': 'Adresse Email',
    'tours.pl.submit': 'R\u00e9server Ma Place',
    'tours.pl.formnote': 'Aucune information de paiement requise ici \u2014 juste votre nom pour r\u00e9server.',
    'tours.pl.success.title': 'Vous \u00eates inscrit!',
    'tours.pl.success.text': 'Compl\u00e9tez maintenant le d\u00e9p\u00f4t pour confirmer votre place.',
    'tours.pl.perks.title': 'Avantages early bird',
    'tours.pl.perks.p1': 'S\u00e9lection prioritaire de chambre',
    'tours.pl.perks.p2': 'Contribuez \u00e0 fa\u00e7onner l\'exp\u00e9rience',
    'tours.pl.perks.p3': 'Garantie de prix fix\u00e9',
    'tours.pl.step2': 'S\u00e9curiser avec un d\u00e9p\u00f4t',
    'tours.pl.or': 'ou',
    'tours.pl.paypal': 'Payer 300$ CAD via PayPal',
    'tours.pl.trust1': '100% remboursable, en tout temps',
    'tours.pl.trust2': 'Confirmation sous 24h',
    'tours.pl.next1': 'Vous rejoignez la liste',
    'tours.pl.next2': 'Chef Davide confirme en 24h',
    'tours.pl.next3': '10 invit\u00e9s atteints = tour confirm\u00e9',
